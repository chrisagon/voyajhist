...
function Dossier_histoire_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field titre_histoire can't be empty */
	if($j('#titre_histoire').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Titre de l\'histoire", close: function(){ /* */ $j('[name=titre_histoire]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Rich HTML area field resume can't be empty */
	var nicresume = nicEditors.findEditor('resume').getContent();
	if(nicresume == '' || nicresume == '<br>' || nicresume == '<br/>' || nicresume == '<br>'){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Resume", close: function(){ /* */ $j('[name=resume]').parents('.form-group').addClass('has-error'); } }); return false; }
	return true;
}
...
function sequence_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field numero_ordre can't be empty */
	if($j('#numero_ordre').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Numero de la s&#233;quence", close: function(){ /* */ $j('[name=numero_ordre]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field titre can't be empty */
	if($j('#titre').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Titre", close: function(){ /* */ $j('[name=titre]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function Objectifs_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field titreobj can't be empty */
	if($j('#titreobj').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Titre de l\'objectif", close: function(){ /* */ $j('[name=titreobj]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function moyens_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field titremoy can't be empty */
	if($j('#titremoy').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Moyen du joueur", close: function(){ /* */ $j('[name=titremoy]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function Objets_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field nom_objet can't be empty */
	if($j('#nom_objet').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Nom objet", close: function(){ /* */ $j('[name=nom_objet]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
...
function lieu_et_scene_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field nom_du_lieu can't be empty */
	if($j('#nom_du_lieu').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Nom du lieu", close: function(){ /* */ $j('[name=nom_du_lieu]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
...
function ref_mission_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field titre can't be empty */
	if($j('#titre').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Titre de la mission", close: function(){ /* */ $j('[name=titre]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
...
function persist_expanded_child(id){
	var expand_these = JSON.parse(localStorage.getItem('Voyajhist.dvp_expand'));
	...
	if($j('[id=' + id + ']').hasClass('active')){
		if(expand_these.indexOf(id) < 0){
			...
			localStorage.setItem('Voyajhist.dvp_expand', JSON.stringify(expand_these));
		}
	}else{
		if(expand_these.indexOf(id) >= 0){
