		...
		$pcConfig = array(
			...
			'chapitre' => array(   
				'rattache_a_dossier' => array(   
					...
					'sortable-fields' => array(0 => '`chapitre`.`id`', 1 => '`chapitre`.`titre`', 2 => '`chapitre`.`Mission`', 3 => '`chapitre`.`resume`', 4 => '`chapitre`.`rattache_a_dossier`', 5 => '`chapitre`.`auteur`'),
					'records-per-page' => 10,
			...
			'sequence' => array(   
				'rattache_a_chapitre' => array(   
					...
					'sortable-fields' => array(0 => '`sequence`.`id_sequence`', 1 => '`sequence`.`numero_ordre`', 2 => '`sequence`.`titre`', 3 => '`sequence`.`rattache_a_chapitre`', 4 => '`sequence`.`difficulte`', 5 => '`sequence`.`description`', 6 => '`sequence`.`auteur`', 7 => '`sequence`.`modele`'),
					'records-per-page' => 10,
					'default-sort-by' => 1,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'Objectifs' => array(   
				'rattache_a_dos2j' => array(   
					...
					'sortable-fields' => array(0 => '`Objectifs`.`id_objectif`', 1 => '`Objectifs`.`titreobj`', 2 => '`Objectifs`.`description_obj`', 3 => '`Objectifs`.`ref_o_gameplay`', 4 => '`Objectifs`.`creer_par`', 5 => '`Objectifs`.`rattache_a_dos2j`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'moyens' => array(   
				'rattache_a_dos2j' => array(   
					...
					'sortable-fields' => array(0 => '`moyens`.`id_moyen`', 1 => '`moyens`.`titremoy`', 2 => '`moyens`.`description_moy`', 3 => '`moyens`.`ref_o_gameplay`', 4 => '`moyens`.`creer_par`', 5 => '`moyens`.`rattache_a_dos2j`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'Objets' => array(   
				'Contient' => array(   
					...
					'sortable-fields' => array(0 => '`Objets`.`id_objet`', 1 => '`Objets`.`nom_objet`', 2 => '`Objets`.`illustration`', 3 => '`Objets`.`typologie`', 4 => '`Objets`.`Aquoisertil`', 5 => '`Objets`.`Contient`', 6 => '`Objets`.`creer_par`', 7 => '`Objets`.`rattache_a_dos2j`', 8 => '`Objets`.`rattache_a_seq`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'personnages' => array(   
				'quepossedetil' => array(   
					...
					'sortable-fields' => array(0 => '`personnages`.`id_perso`', 1 => '`personnages`.`nom`', 2 => '`personnages`.`type`', 3 => '`personnages`.`illustration`', 4 => '`personnages`.`description`', 5 => '`personnages`.`quepossedetil`', 6 => '`personnages`.`apparait_quand`', 7 => '`personnages`.`disparait_quand`', 8 => '`personnages`.`creer_par`', 9 => '`personnages`.`rattache_a_dos2j`', 10 => '`personnages`.`rattache_a_seq`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'lieu_et_scene' => array(   
				'objet_present' => array(   
					...
					'sortable-fields' => array(0 => '`lieu_et_scene`.`id_lets`', 1 => '`lieu_et_scene`.`nom_du_lieu`', 2 => '`lieu_et_scene`.`illustration`', 3 => '`lieu_et_scene`.`description`', 4 => '`lieu_et_scene`.`difficulte_nivo`', 5 => '`lieu_et_scene`.`condition_entree`', 6 => '`lieu_et_scene`.`condition_sortie`', 7 => '`lieu_et_scene`.`objet_present`', 8 => '`lieu_et_scene`.`persos_present`', 9 => '`lieu_et_scene`.`creer_par`', 10 => '`lieu_et_scene`.`rattache_a_dos2j`', 11 => '`lieu_et_scene`.`rattache_a_seq`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
