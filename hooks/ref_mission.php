<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ref_mission' table. 
	...
	*/
	...
	function ref_mission_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function ref_mission_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function ref_mission_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre'], $data['description'], $data['num_ord']
	...
	*/
	...
	function ref_mission_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ref_mission_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_misref'], $data['titre'], $data['description'], $data['num_ord']
	...
	*/
	...
	function ref_mission_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ref_mission_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function ref_mission_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function ref_mission_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function ref_mission_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function ref_mission_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function ref_mission_batch_actions(&$args){
