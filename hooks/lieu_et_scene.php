<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'lieu_et_scene' table. 
	...
	*/
	...
	function lieu_et_scene_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function lieu_et_scene_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function lieu_et_scene_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['nom_du_lieu'], $data['illustration'], $data['description'], $data['difficulte_nivo'], $data['condition_entree'], $data['condition_sortie'], $data['objet_present'], $data['persos_present'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function lieu_et_scene_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['nom_du_lieu'], $data['illustration'], $data['description'], $data['difficulte_nivo'], $data['condition_entree'], $data['condition_sortie'], $data['objet_present'], $data['persos_present'], $data['creer_par'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function lieu_et_scene_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function lieu_et_scene_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_lets'], $data['nom_du_lieu'], $data['illustration'], $data['description'], $data['difficulte_nivo'], $data['condition_entree'], $data['condition_sortie'], $data['objet_present'], $data['persos_present'], $data['creer_par'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function lieu_et_scene_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function lieu_et_scene_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function lieu_et_scene_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function lieu_et_scene_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function lieu_et_scene_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function lieu_et_scene_batch_actions(&$args){
