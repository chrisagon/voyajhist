<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ref_badges' table. 
	...
	*/
	...
	function ref_badges_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function ref_badges_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function ref_badges_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre'], $data['description'], $data['domaine'], $data['score_min'], $data['score_max'], $data['icone_badge']
	...
	*/
	...
	function ref_badges_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ref_badges_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function ref_badges_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_badge'], $data['titre'], $data['description'], $data['domaine'], $data['score_min'], $data['score_max'], $data['icone_badge']
	...
	*/
	...
	function ref_badges_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function ref_badges_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function ref_badges_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function ref_badges_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function ref_badges_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function ref_badges_batch_actions(&$args){
