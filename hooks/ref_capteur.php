<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ref_capteur' table. 
	...
	*/
	...
	function ref_capteur_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function ref_capteur_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function ref_capteur_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['nom'], $data['fonction'], $data['reference'], $data['fichier']
	...
	*/
	...
	function ref_capteur_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ref_capteur_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['nom'], $data['fonction'], $data['reference'], $data['fichier']
	...
	*/
	...
	function ref_capteur_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ref_capteur_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function ref_capteur_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function ref_capteur_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function ref_capteur_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function ref_capteur_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function ref_capteur_batch_actions(&$args){
