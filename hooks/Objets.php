<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Objets' table. 
	...
	*/
	...
	function Objets_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function Objets_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function Objets_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['nom_objet'], $data['illustration'], $data['typologie'], $data['Aquoisertil'], $data['Contient'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function Objets_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['nom_objet'], $data['illustration'], $data['typologie'], $data['Aquoisertil'], $data['Contient'], $data['creer_par'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function Objets_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function Objets_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_objet'], $data['nom_objet'], $data['illustration'], $data['typologie'], $data['Aquoisertil'], $data['Contient'], $data['creer_par'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function Objets_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function Objets_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function Objets_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function Objets_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function Objets_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function Objets_batch_actions(&$args){
