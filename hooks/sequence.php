<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'sequence' table. 
	...
	*/
	...
	function sequence_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function sequence_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function sequence_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['numero_ordre'], $data['titre'], $data['difficulte'], $data['description'], $data['modele']
	...
	*/
	...
	function sequence_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['numero_ordre'], $data['titre'], $data['rattache_a_chapitre'], $data['difficulte'], $data['description'], $data['auteur'], $data['modele']
	...
	*/
	...
	function sequence_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function sequence_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_sequence'], $data['numero_ordre'], $data['titre'], $data['rattache_a_chapitre'], $data['difficulte'], $data['description'], $data['auteur'], $data['modele']
	...
	*/
	...
	function sequence_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function sequence_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function sequence_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function sequence_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function sequence_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function sequence_batch_actions(&$args){
