<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'boiteaid' table. 
	...
	*/
	...
	function boiteaid_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function boiteaid_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function boiteaid_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre'], $data['commentaire'], $data['Capteur']
	...
	*/
	...
	function boiteaid_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function boiteaid_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['titre'], $data['commentaire'], $data['Capteur']
	...
	*/
	...
	function boiteaid_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function boiteaid_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function boiteaid_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function boiteaid_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function boiteaid_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function boiteaid_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function boiteaid_batch_actions(&$args){
