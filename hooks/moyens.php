<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'moyens' table. 
	...
	*/
	...
	function moyens_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function moyens_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function moyens_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titremoy'], $data['description_moy'], $data['ref_o_gameplay'], $data['rattache_a_dos2j']
	...
	*/
	...
	function moyens_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['titremoy'], $data['description_moy'], $data['ref_o_gameplay'], $data['creer_par'], $data['rattache_a_dos2j']
	...
	*/
	...
	function moyens_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function moyens_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_moyen'], $data['titremoy'], $data['description_moy'], $data['ref_o_gameplay'], $data['creer_par'], $data['rattache_a_dos2j']
	...
	*/
	...
	function moyens_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function moyens_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function moyens_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function moyens_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function moyens_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function moyens_batch_actions(&$args){
