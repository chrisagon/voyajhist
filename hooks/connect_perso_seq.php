<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'connect_perso_seq' table. 
	...
	*/
	...
	function connect_perso_seq_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function connect_perso_seq_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function connect_perso_seq_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function connect_perso_seq_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function connect_perso_seq_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function connect_perso_seq_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function connect_perso_seq_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function connect_perso_seq_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function connect_perso_seq_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function connect_perso_seq_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function connect_perso_seq_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function connect_perso_seq_batch_actions(&$args){
