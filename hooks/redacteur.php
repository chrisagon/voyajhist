<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'redacteur' table. 
	...
	*/
	...
	function redacteur_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function redacteur_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function redacteur_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['prenom'], $data['nom'], $data['email'], $data['score_total'], $data['badges']
	...
	*/
	...
	function redacteur_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['member_id'], $data['prenom'], $data['nom'], $data['email'], $data['score_total'], $data['badges'], $data['score_hist'], $data['score_obj'], $data['score_moy'], $data['score_objets'], $data['score_perso'], $data['score_lets']
	...
	*/
	...
	function redacteur_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function redacteur_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_redact'], $data['member_id'], $data['prenom'], $data['nom'], $data['email'], $data['score_total'], $data['badges'], $data['score_hist'], $data['score_obj'], $data['score_moy'], $data['score_objets'], $data['score_perso'], $data['score_lets']
	...
	*/
	...
	function redacteur_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function redacteur_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function redacteur_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function redacteur_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function redacteur_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function redacteur_batch_actions(&$args){
