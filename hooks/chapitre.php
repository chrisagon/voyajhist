<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'chapitre' table. 
	...
	*/
	...
	function chapitre_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function chapitre_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function chapitre_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre'], $data['resume'], $data['rattache_a_dossier']
	...
	*/
	...
	function chapitre_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['titre'], $data['resume'], $data['rattache_a_dossier'], $data['auteur']
	...
	*/
	...
	function chapitre_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function chapitre_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['titre'], $data['resume'], $data['rattache_a_dossier'], $data['auteur']
	...
	*/
	...
	function chapitre_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function chapitre_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function chapitre_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function chapitre_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function chapitre_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function chapitre_batch_actions(&$args){
