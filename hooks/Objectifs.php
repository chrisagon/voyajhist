<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Objectifs' table. 
	...
	*/
	...
	function Objectifs_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function Objectifs_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function Objectifs_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titreobj'], $data['description_obj'], $data['ref_o_gameplay'], $data['rattache_a_dos2j']
	...
	*/
	...
	function Objectifs_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['titreobj'], $data['description_obj'], $data['ref_o_gameplay'], $data['creer_par'], $data['rattache_a_dos2j']
	...
	*/
	...
	function Objectifs_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function Objectifs_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_objectif'], $data['titreobj'], $data['description_obj'], $data['ref_o_gameplay'], $data['creer_par'], $data['rattache_a_dos2j']
	...
	*/
	...
	function Objectifs_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function Objectifs_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function Objectifs_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function Objectifs_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function Objectifs_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function Objectifs_batch_actions(&$args){
