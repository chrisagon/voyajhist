<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Dossier_histoire' table. 
	...
	*/
	...
	function Dossier_histoire_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function Dossier_histoire_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function Dossier_histoire_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre_histoire'], $data['resume']
	...
	*/
	...
	function Dossier_histoire_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['auteur'], $data['titre_histoire'], $data['resume'], $data['creer_par']
	...
	*/
	...
	function Dossier_histoire_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function Dossier_histoire_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id2dossier'], $data['auteur'], $data['titre_histoire'], $data['resume'], $data['creer_par']
	...
	*/
	...
	function Dossier_histoire_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function Dossier_histoire_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function Dossier_histoire_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function Dossier_histoire_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function Dossier_histoire_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function Dossier_histoire_batch_actions(&$args){
