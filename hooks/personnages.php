<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'personnages' table. 
	...
	*/
	...
	function personnages_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function personnages_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function personnages_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['nom'], $data['type'], $data['illustration'], $data['description'], $data['quepossedetil'], $data['apparait_quand'], $data['disparait_quand'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function personnages_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['nom'], $data['type'], $data['illustration'], $data['description'], $data['quepossedetil'], $data['apparait_quand'], $data['disparait_quand'], $data['creer_par'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function personnages_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function personnages_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id_perso'], $data['nom'], $data['type'], $data['illustration'], $data['description'], $data['quepossedetil'], $data['apparait_quand'], $data['disparait_quand'], $data['creer_par'], $data['rattache_a_dos2j'], $data['rattache_a_seq']
	...
	*/
	...
	function personnages_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function personnages_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function personnages_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function personnages_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function personnages_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function personnages_batch_actions(&$args){
