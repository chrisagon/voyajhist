<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ref_sequences' table. 
	...
	*/
	...
	function ref_sequences_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function ref_sequences_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function ref_sequences_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre'], $data['description'], $data['typologie'], $data['num_ord']
	...
	*/
	...
	function ref_sequences_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ref_sequences_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id_seqref'], $data['titre'], $data['description'], $data['typologie'], $data['num_ord']
	...
	*/
	...
	function ref_sequences_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ref_sequences_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function ref_sequences_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function ref_sequences_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function ref_sequences_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function ref_sequences_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function ref_sequences_batch_actions(&$args){
