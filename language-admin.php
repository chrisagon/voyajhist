<?php
	...
	$Translation['server status disabled'] = 'L\'&eacute;tat du serveur est d&eacute;sactiv&eacute; sur cette application. Pour l\'activer, r&eacute;g&eacute;n&eacute;rez l\'application avec l\'option "Autoriser le statut du serveur dans la zone d\'administration" activ&eacute;e.';
	$Translation['server status'] = 'Server status';
	$Translation['db status'] = 'Database status';
	$Translation['generated by'] = 'Cette application a &eacute;t&eacute; g&eacute;n&eacute;r&eacute; avec AppGini <VERSION> le <DATETIME>.';
	$Translation['column table name'] = 'Nom de la Table ';
	$Translation['db storage'] = 'Taille de la BDD';
	$Translation['column size kb'] = 'Taille (Ko)';
